...
<c:choose>
	...
	<c:otherwise>
		<%
			String[] airlines = {"AA", "DL", "UA", "WN", "B6", "AS",
							"NK", "F9"};
		...
		<div class="well well-sm span4">
			...
			<form class="form-horizontal form-group-sm" role="form" name="input"
				action='<c:url value="FlightSearchQuery"></c:url>' method="post"
				id="input">
				<div class="form-group">
					<label class="col-sm-2 control-label" for="source">From</label> <select
						name="source" form="input" id="source" required>
						<option value=""></option>
				...
				<div class="form-group">
					...
					<input type="text" style="margin-left: 1px" class="form-group"
						id="departure" name="departure" readonly="readonly" required>
				</div>
				<button type="submit" class="btn btn-primary btn-sm col-md-offset-2"
					value="Search" data-toggle="modal"
					data-target=".bs-example-modal-sm">Search</button>
				<button type="button" class="btn btn-danger btn-sm" value="Exit"
					onClick="window.location='login.jsp'">Exit</button>
			</form>
		</div>
			...
			<div class="modal-dialog"
				...
				<div class="modal-content">
					<div class="modal-body">
						Please, wait while we load the results or hit <strong>ESC</strong>
						to redo your search! <img alt="Wait symbol" src="style/wait.gif"
							style="width: 50px; height: 50px; margin-left: 5%">
					</div>
				</div>
			</div>
		</div>
